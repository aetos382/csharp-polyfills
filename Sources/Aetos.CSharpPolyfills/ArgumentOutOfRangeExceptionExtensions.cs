...
#pragma warning restore
        ...
        public static void ThrowIfNegativeOrZero(byte value, [CallerArgumentExpression(nameof(value))] string? paramName = null)
        {
            ThrowIf(value == 0, paramName);
        }
        ...
        public static void ThrowIfNegativeOrZero(ushort value, [CallerArgumentExpression(nameof(value))] string? paramName = null)
        {
            ThrowIf(value == 0, paramName);
        }
        ...
        public static void ThrowIfNegativeOrZero(uint value, [CallerArgumentExpression(nameof(value))] string? paramName = null)
        {
            ThrowIf(value == 0, paramName);
        }
        ...
        public static void ThrowIfNegativeOrZero(ulong value, [CallerArgumentExpression(nameof(value))] string? paramName = null)
        {
            ThrowIf(value == 0, paramName);
        }
        ...
        public static void ThrowIfNegativeOrZero(nuint value, [CallerArgumentExpression(nameof(value))] string? paramName = null)
        {
            ThrowIf(value == 0, paramName);
        }
